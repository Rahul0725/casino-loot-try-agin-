...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        ...
        [InlineKeyboardButton("🎯 Teen Patti", callback_data="teenpatti")],
        [InlineKeyboardButton("💵 Free Income", callback_data="income")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text("🎁 Choose a category below 👇", reply_markup=reply_markup)
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = messages.get(query.data, "⚠️ Unknown category")
